import hashlib
import binascii
#this python script is designed to print out the differing number of bits between two files ('msg1.txt' and 'msg2.txt'). The contents of these two files were put through the sha256 hash algorithm
file1 = open("msg1.txt", "r")
file2 = open("msg2.txt", "r")
file1Contents = file1.read()
file2Contents = file2.read()
#run the file contents through sha256 algorithm
hash_object1 = hashlib.sha256(file1Contents)
hash_object2 = hashlib.sha256(file2Contents)
